...
// public:
//   void push(const UBankedAddress address) {
//     if (pushCount - popCount >= STACKSIZE) {
//       WarningCondition(PUSH);
//       return;
//     }
...
//   int getCurrentStackPosition() const { return pushCount - popCount - 1; }

//   int getCount() const { return pushCount + popCount; }

//   bool isOverflow() const { return getCurrentStackPosition() >= STACKSIZE - 1; }

//   bool isUnderflow() const { return getCurrentStackPosition() == -1; }
...
// protected:
//   void WarningCondition(const EDirection direction) {}
